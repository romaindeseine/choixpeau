	...
	tests := []struct {
		...
		},
		{
			...
			exp: Experiment{
				...
				Status:   StatusRunning,
				Variants: []Variant{{Name: "a", Weight: 1}},
				Layer:    Layer{Name: "checkout", From: 0, To: 30},
			},
		},
		{
			name: "valid layer with zero traffic (from == to)",
			exp: Experiment{
				Slug:     "test",
				Status:   StatusRunning,
				Variants: []Variant{{Name: "a", Weight: 1}},
		...
		{
			name: "layer with empty name",
			exp: Experiment{
				Slug:     "test",
				Status:   StatusRunning,
				Variants: []Variant{{Name: "a", Weight: 1}},
				Layer:    Layer{Name: "", From: 0, To: 30},
			},
			wantErr: true,
		},
		{
			name: "layer from greater than to",
			exp: Experiment{
				Slug:     "test",
				Status:   StatusRunning,
				Variants: []Variant{{Name: "a", Weight: 1}},
				Layer:    Layer{Name: "checkout", From: 50, To: 30},
			},
			wantErr: true,
		},
		{
			name: "layer from negative",
			exp: Experiment{
				Slug:     "test",
				Status:   StatusRunning,
				Variants: []Variant{{Name: "a", Weight: 1}},
				Layer:    Layer{Name: "checkout", From: -1, To: 30},
			},
			wantErr: true,
		},
		{
			name: "layer to over 100",
			exp: Experiment{
				Slug:     "test",
				Status:   StatusRunning,
				Variants: []Variant{{Name: "a", Weight: 1}},
				Layer:    Layer{Name: "checkout", From: 0, To: 101},
			},
			wantErr: true,
		},
	}
